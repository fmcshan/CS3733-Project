...
public class GiftDeliveryRequest {
     ...
     */
    public boolean nameInputValid() { return nameInput.getText().contains(" ");}

    /**
     * Checks if a checkbox has been selected
     * @return true if any checkbox has been selected, and false otherwise
     */
    public boolean checkBoxSelected() { return teddyBearBox.isSelected() || chocolateBox.isSelected() || giftBasketBox.isSelected() || otherCheckbox.isSelected();}
     ...
     */
    public boolean otherInputValid() { return !otherCheckbox.isSelected() || (otherCheckbox.isSelected() && !otherInput.getText().isEmpty());}
     ...
     */
    public boolean phoneNumberValid() { return phoneInput.getText().matches("\\d{3}-\\d{3}-\\d{4}");}
